...
var _user$project$Model$createEntry = F4(
	function (productName, adEnabled, channels, token) {
		return {productName: productName, isAdReplacementEnabled: adEnabled, adReplacementChannels: channels, isTokenRequired: token};
	});
var _user$project$Model$initialModel = {
	oldAdreplacementEntry: A4(_user$project$Model$createEntry, 'ios', true, '', true),
	newAdreplacementEntry: A4(_user$project$Model$createEntry, 'ios', true, '', true)
};
var _user$project$Model$Model = F2(
	function (a, b) {
		return {oldAdreplacementEntry: a, newAdreplacementEntry: b};
	});
var _user$project$Model$AdReplacementEntry = F4(
	function (a, b, c, d) {
		return {productName: a, isAdReplacementEnabled: b, adReplacementChannels: c, isTokenRequired: d};
	});

var _user$project$HttpUtils$adReplacementEntryEncoder = function (entry) {
	var attributes = {
		ctor: '::',
		_0: {
			ctor: '_Tuple2',
			_0: 'product',
			_1: _elm_lang$core$Json_Encode$string(entry.productName)
		},
		_1: {
			ctor: '::',
			_0: {
				ctor: '_Tuple2',
				_0: 'isAdReplacementEnabled',
				_1: _elm_lang$core$Json_Encode$bool(entry.isAdReplacementEnabled)
			},
			_1: {
				ctor: '::',
				_0: {
					ctor: '_Tuple2',
					_0: 'adReplacementChannels',
					_1: _elm_lang$core$Json_Encode$string(entry.adReplacementChannels)
				},
				_1: {
					ctor: '::',
					_0: {
						ctor: '_Tuple2',
						_0: 'isTokenRequired',
						_1: _elm_lang$core$Json_Encode$bool(entry.isTokenRequired)
					},
					_1: {ctor: '[]'}
				}
			}
...
var _user$project$HttpUtils$entryListEncoder = function (entry) {
	return _elm_lang$core$Json_Encode$list(
		{
			ctor: '::',
			_0: _user$project$HttpUtils$adReplacementEntryEncoder(entry),
			_1: {ctor: '[]'}
		});
};
var _user$project$HttpUtils$adReplacementEntryDecoder = A3(
	_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$required,
	'isTokenRequired',
	_elm_lang$core$Json_Decode$bool,
	A3(
		_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$required,
		'adReplacementChannels',
		_elm_lang$core$Json_Decode$string,
		A3(
			_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$required,
			'isAdReplacementEnabled',
			_elm_lang$core$Json_Decode$bool,
			A3(
				_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$required,
				'product',
				_elm_lang$core$Json_Decode$string,
				_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$decode(_user$project$Model$AdReplacementEntry)))));
var _user$project$HttpUtils$adReplacementSettingsDecoder = A2(
	_elm_lang$core$Json_Decode$at,
	{
		ctor: '::',
		_0: 'adReplacementSettings',
		_1: {ctor: '[]'}
	},
	_elm_lang$core$Json_Decode$list(_user$project$HttpUtils$adReplacementEntryDecoder));

var _user$project$Msg$Fetch = function (a) {
	return {ctor: 'Fetch', _0: a};
};
var _user$project$Msg$UpdateChoices = function (a) {
	return {ctor: 'UpdateChoices', _0: a};
};
var _user$project$Msg$Update = {ctor: 'Update'};
var _user$project$Msg$NewProduct = function (a) {
	return {ctor: 'NewProduct', _0: a};
};
var _user$project$Msg$TokenRequired = function (a) {
	return {ctor: 'TokenRequired', _0: a};
};
var _user$project$Msg$Channel = function (a) {
	return {ctor: 'Channel', _0: a};
};
var _user$project$Msg$YospaceAdReplacementEnabled = function (a) {
	return {ctor: 'YospaceAdReplacementEnabled', _0: a};
};

var _user$project$Update_Actions$updateAdreplacementSettings = function (model) {
	return _elm_lang$core$Native_Utils.update(
		model,
		{oldAdreplacementEntry: model.newAdreplacementEntry});
};
var _user$project$Update_Actions$fetchAdreplacementSettings = F2(
	function (model, entry) {
		return _elm_lang$core$Native_Utils.update(
			model,
			{
				oldAdreplacementEntry: A2(
					_elm_lang$core$Maybe$withDefault,
					model.oldAdreplacementEntry,
					_elm_lang$core$List$head(
						_elm_lang$core$List$reverse(entry)))
			});
	});
var _user$project$Update_Actions$newProduct = F2(
	function (newProduct, model) {
		var oldEntry = model.newAdreplacementEntry;
		...
		return {
			...
			_0: _elm_lang$core$Native_Utils.update(
				model,
				{newAdreplacementEntry: newEntry}),
			_1: _elm_lang$core$Platform_Cmd$none
		};
	});
var _user$project$Update_Actions$tokenRequired = F2(
	function ($boolean, model) {
		var oldEntry = model.newAdreplacementEntry;
		var newEntry = _elm_lang$core$Native_Utils.update(
			oldEntry,
...
var _user$project$Update_Actions$deleteChannel = F2(
	function (oldString, newString) {
		var channelList = A2(_elm_lang$core$String$split, ', ', oldString);
		return A2(
			_elm_lang$core$String$join,
			', ',
			A2(
				_elm_community$list_extra$List_Extra$filterNot,
				_elm_lang$core$String$contains(newString),
				channelList));
	});
var _user$project$Update_Actions$channel = F2(
	function (name, model) {
		var oldEntry = model.newAdreplacementEntry;
		var newEntry = _elm_lang$core$Native_Utils.update(
			oldEntry,
			{
				adReplacementChannels: A2(
					_Fresheyeball$elm_guards$Guards_ops['|='],
					A2(
						_Fresheyeball$elm_guards$Guards_ops['=>'],
						_elm_lang$core$String$isEmpty(oldEntry.adReplacementChannels),
						name),
					A2(
						_Fresheyeball$elm_guards$Guards_ops['|='],
						A2(
							_Fresheyeball$elm_guards$Guards_ops['=>'],
							A2(_elm_lang$core$String$contains, name, oldEntry.adReplacementChannels),
							A2(_user$project$Update_Actions$deleteChannel, oldEntry.adReplacementChannels, name)),
						A2(
							_elm_lang$core$Basics_ops['++'],
...
var _user$project$Update_Actions$yospaceAdReplacementEnabled = F2(
	function ($boolean, model) {
		var oldEntry = model.newAdreplacementEntry;
		var newEntry = _elm_lang$core$Native_Utils.update(
			oldEntry,
			{isAdReplacementEnabled: $boolean});
		return {
			ctor: '_Tuple2',
			_0: _elm_lang$core$Native_Utils.update(
				model,
...
var _user$project$Update_Http$putRequest = function (entry) {
	return _elm_lang$http$Http$request(
		{
			method: 'PUT',
			headers: {
			...
			body: _elm_lang$http$Http$jsonBody(
				_user$project$HttpUtils$adReplacementEntryEncoder(entry)),
...
var _user$project$Update_Http$submitChoices = function (entry) {
	var x = _user$project$Update_Http$putRequest(entry);
	var y = A2(_elm_lang$core$Debug$log, 'request is ', x);
	return A2(
		_elm_lang$http$Http$send,
		_user$project$Msg$UpdateChoices,
		_user$project$Update_Http$putRequest(entry));
};
var _user$project$Update_Http$fetchData = function () {
	var url = '/ad-replacement';
	return A2(
		_elm_lang$http$Http$send,
		_user$project$Msg$Fetch,
		A2(_elm_lang$http$Http$get, url, _user$project$HttpUtils$adReplacementSettingsDecoder));
}();
...
var _user$project$Update_Main$update = F2(
	function (msg, model) {
		var _p0 = msg;
		switch (_p0.ctor) {
			case 'YospaceAdReplacementEnabled':
				return A2(_user$project$Update_Actions$yospaceAdReplacementEnabled, _p0._0, model);
			case 'Channel':
				return A2(_user$project$Update_Actions$channel, _p0._0, model);
			case 'TokenRequired':
				return A2(_user$project$Update_Actions$tokenRequired, _p0._0, model);
			case 'NewProduct':
				return A2(_user$project$Update_Actions$newProduct, _p0._0, model);
			case 'Update':
				return {
					ctor: '_Tuple2',
					_0: model,
					_1: _user$project$Update_Http$submitChoices(model.newAdreplacementEntry)
				};
			case 'UpdateChoices':
				if (_p0._0.ctor === 'Ok') {
					return {
						ctor: '_Tuple2',
						_0: _user$project$Update_Actions$updateAdreplacementSettings(model),
						_1: _elm_lang$core$Platform_Cmd$none
					};
				} else {
			...
			default:
				if (_p0._0.ctor === 'Ok') {
					return {
						ctor: '_Tuple2',
						_0: A2(_user$project$Update_Actions$fetchAdreplacementSettings, model, _p0._0._0),
						_1: _elm_lang$core$Platform_Cmd$none
					};
				} else {
					return {ctor: '_Tuple2', _0: model, _1: _elm_lang$core$Platform_Cmd$none};
...
var _user$project$View_Main$checkbox = F2(
	function (name, msg) {
		return A2(
			_elm_lang$html$Html$label,
			{
...
var _user$project$View_Main$radio = F3(
	function (groupName, value, msg) {
		return A2(
			_elm_lang$html$Html$label,
			{ctor: '[]'},
			{
				...
				_0: A2(
					_elm_lang$html$Html$input,
					{
						...
						_1: {
							ctor: '::',
							_0: _elm_lang$html$Html_Attributes$name(groupName),
							_1: {
								ctor: '::',
								_0: _elm_lang$html$Html_Events$onClick(msg),
								_1: {ctor: '[]'}
...
var _user$project$View_Main$dbButtons = function (model) {
	return A2(
										...
										_rundis$elm_bootstrap$Bootstrap_Button$linkButton,
										{
											...
											_1: {
												...
												_0: _rundis$elm_bootstrap$Bootstrap_Button$attrs(
													{
														ctor: '::',
														_0: _elm_lang$html$Html_Events$onClick(_user$project$Msg$Update),
														_1: {ctor: '[]'}
													}),
												_1: {ctor: '[]'}
											}
...
var _user$project$View_Main$viewData = F2(
	function (title, entry) {
		return A2(
			_elm_lang$html$Html$div,
			{
				ctor: '::',
				_0: _elm_lang$html$Html_Attributes$class('col-md-4 two-column-table'),
				_1: {ctor: '[]'}
			},
			{
				ctor: '::',
												...
												_0: A2(
													...
													{ctor: '[]'},
													{
														...
														_0: _elm_lang$html$Html$text(
															_elm_lang$core$Basics$toString(entry.productName)),
														_1: {ctor: '[]'}
													}),
												_1: {ctor: '[]'}
											}
										...
										_0: A2(
											...
											{ctor: '[]'},
											{
												...
												_0: A2(
													...
													{
														ctor: '::',
														_0: _elm_lang$html$Html$text('Is AdReplacement enabled?'),
														_1: {ctor: '[]'}
													}),
												_1: {
													ctor: '::',
													_0: A2(
														...
														{ctor: '[]'},
														{
															ctor: '::',
															_0: _elm_lang$html$Html$text(
																_elm_lang$core$Basics$toString(entry.isAdReplacementEnabled)),
															_1: {ctor: '[]'}
														}),
													_1: {ctor: '[]'}
												}
											...
											_0: A2(
												...
												{ctor: '[]'},
												{
													...
													_0: A2(
														...
														{
															ctor: '::',
															_0: _elm_lang$html$Html$text('AdReplacement Channels'),
															_1: {ctor: '[]'}
														}),
													_1: {
														ctor: '::',
														_0: A2(
															...
															{ctor: '[]'},
															{
																ctor: '::',
																_0: _elm_lang$html$Html$text(
																	_elm_lang$core$Basics$toString(entry.adReplacementChannels)),
																_1: {ctor: '[]'}
															}),
														_1: {ctor: '[]'}
													}
												...
												_0: A2(
													...
													{ctor: '[]'},
													{
														...
														_0: A2(
															...
															{
																ctor: '::',
																_0: _elm_lang$html$Html$text('Is Token Required?'),
																_1: {ctor: '[]'}
															}),
														_1: {
															ctor: '::',
															_0: A2(
																...
																{ctor: '[]'},
																{
																	ctor: '::',
																	_0: _elm_lang$html$Html$text(
																		_elm_lang$core$Basics$toString(entry.isTokenRequired)),
																	_1: {ctor: '[]'}
																}),
															_1: {ctor: '[]'}
														}
...
var _user$project$View_Main$selectChannel = function (channels) {
	return A2(
		_elm_lang$core$List$map,
		function (x) {
			return A2(
				_user$project$View_Main$checkbox,
				x,
				_user$project$Msg$Channel(x));
		},
		channels);
};
var _user$project$View_Main$row = F2(
...
var _user$project$View_Main$col = F2(
	function (colSize, $function) {
		return A2(
			_rundis$elm_bootstrap$Bootstrap_Grid$col,
			{
				ctor: '::',
...
var _user$project$View_Main$form = function (model) {
	return A2(
		_rundis$elm_bootstrap$Bootstrap_Grid$container,
		{ctor: '[]'},
		{
			...
			_0: A2(
				...
				{
					ctor: '::',
					_0: _elm_lang$html$Html$text('Update AdReplacement Settings'),
					_1: {ctor: '[]'}
				}),
			_1: {
				ctor: '::',
				_0: A2(
					_user$project$View_Main$row,
					'selectSettings',
					{
						ctor: '::',
						_0: A2(
							_user$project$View_Main$col,
							_rundis$elm_bootstrap$Bootstrap_Grid_Col$xs4,
							_elm_lang$html$Html$text('Product is')),
						_1: {
							ctor: '::',
							_0: A2(
								_user$project$View_Main$col,
								_rundis$elm_bootstrap$Bootstrap_Grid_Col$xs6,
								A3(
									_lgastako$elm_select$Select$fromSelected,
									{
										ctor: '::',
										_0: 'ios',
										_1: {ctor: '[]'}
									},
									_user$project$Msg$NewProduct,
									'ios')),
							_1: {ctor: '[]'}
						}
					}),
					...
					_0: A2(
						...
						'selectSettings',
						{
							...
							_0: A2(
								_user$project$View_Main$col,
								_rundis$elm_bootstrap$Bootstrap_Grid_Col$xs4,
								_elm_lang$html$Html$text('Is AdReplacement enabled?')),
							_1: {
								ctor: '::',
								_0: A2(
									_user$project$View_Main$col,
									...
									A2(
										...
										{ctor: '[]'},
										{
											ctor: '::',
											_0: A3(
												_user$project$View_Main$radio,
												'yospace',
												'True',
												_user$project$Msg$YospaceAdReplacementEnabled(true)),
											_1: {
												ctor: '::',
												_0: A3(
													_user$project$View_Main$radio,
													'yospace',
													'False',
													_user$project$Msg$YospaceAdReplacementEnabled(false)),
												_1: {ctor: '[]'}
											}
										})),
								_1: {ctor: '[]'}
						...
						_0: A2(
							...
							'selectSettings',
							{
								...
								_0: A2(
									_user$project$View_Main$col,
									_rundis$elm_bootstrap$Bootstrap_Grid_Col$xs4,
									_elm_lang$html$Html$text('What are the AdReplacement-enabled channels?')),
								_1: {
									ctor: '::',
									_0: A2(
										_user$project$View_Main$col,
										...
										A2(
											_elm_lang$html$Html$fieldset,
											{ctor: '[]'},
											_user$project$View_Main$selectChannel(
												{
													ctor: '::',
													_0: 'itv1',
													_1: {
							...
							_0: A2(
								...
								'selectSettings',
								{
									...
									_0: A2(
										_user$project$View_Main$col,
										_rundis$elm_bootstrap$Bootstrap_Grid_Col$xs4,
										_elm_lang$html$Html$text('Is Token Required?')),
									_1: {
										ctor: '::',
										_0: A2(
											_user$project$View_Main$col,
											...
											A2(
												...
												{ctor: '[]'},
												{
													...
													_0: A3(
														...
														'akamai',
														'True',
														_user$project$Msg$TokenRequired(true)),
													_1: {
														ctor: '::',
														_0: A3(
															_user$project$View_Main$radio,
															'akamai',
															'False',
															_user$project$Msg$TokenRequired(false)),
														_1: {ctor: '[]'}
													}
												})),
										_1: {ctor: '[]'}
...
var _user$project$View_Main$view = function (model) {
	return A2(
		...
		{
			ctor: '::',
			_0: _user$project$View_Main$form(model),
			_1: {
				ctor: '::',
				_0: A2(_user$project$View_Main$viewData, 'Current state', model.oldAdreplacementEntry),
				_1: {
					ctor: '::',
					_0: _user$project$View_Main$dbButtons(model),
					_1: {ctor: '[]'}
				}
			}
		});
...
var _user$project$Main$init = A2(
	...
	{
		ctor: '::',
		_0: _user$project$Update_Http$fetchData,
		_1: {ctor: '[]'}
	});
var _user$project$Main$main = _elm_lang$html$Html$program(
	{
		init: _user$project$Main$init,
		view: _user$project$View_Main$view,
		update: _user$project$Update_Main$update,
